      ...
      <div className="container mx-auto flex flex-col justify-center">
        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24 mx-4 md:px-8 lg:mx-16">
          ...
          <div className="text-zone w-full md:w-1/2 space-y-5 relative order-2 xl:order-none">
            <h1 className="text-3xl md:text-4xl xl:text-5xl font-vi relative">
            ...
            <p className="text-sm md:text-lg font-robo md:text-left text-white animate-bounceIn">
          ...
          <div className="order-1 xl:order-none mb-6 xl:mb-0 flex justify-center xl:justify-start xl:ml-[-5%] animate-rubberBand">
