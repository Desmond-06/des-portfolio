    ...
    <div className="relative overflow-hidden">
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center p-4">
        ...
        <div className="text-zone w-full lg:w-1/2">
          <h1 className="text-5xl font-bold mb-5 font-second animate-bounceIn text-white hover:animate-bounce">
            Contact Me
          </h1>
          <div className="w-[18rem] h-1 bg-white animate-bounceIn absolute top-[4rem] left-[1rem]"></div>
